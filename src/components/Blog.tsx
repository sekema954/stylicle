...
export const blogs = [
  { id: 1, title: "Discover the secret to beauty.", content:"Regular trims are also essential for maintaining healthy hair. Cutting split ends helps to prevent further damage, ensuring that your hair grows long and strong. You don’t need to rush to the salon for trims; doing it yourself every few weeks can make a huge difference. Trimming your hair regularly not only prevents breakage but also keeps it looking fresh and voluminous. It’s a small step that can go a long way in achieving healthier, shinier locks.In addition to trimming, maintaining a proper hair care routine is crucial.", thumbnail: image3, date: "December 26, 2021" },
    ...
    <section className="py-10">
      ...
      >
        {blogs.map((data) => (
          <article
            key={data.id}
            className="card lg:w-[370px] border px-3 py-3 shadow-lg flex flex-col h-full"
          >
            {/** Thumbnail */}
